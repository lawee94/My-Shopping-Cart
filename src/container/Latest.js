...
class Latest extends Component {
    state = {
        count: this.props.latest.length / 4
    } 
            ...
            <section className="container-fluid">
                <div className="row">
                    ...
                    <div className='w-100 px-4'>
                        <h4 className="title" >
                            <span className="float-left"><span className="text"><span className="line">Latest <strong>Products</strong></span></span></span>
                            <span className="float-right">
                                <a className="left button" href="#latest" data-slide="prev"> </a>
                                <a className="right button" href="#latest" data-slide="next"> </a>
                            </span>
                        </h4>
                    </div>

                    <div  className="container-fluid">
                        <div id="latest" className=" carousel slide">
                            <div className="carousel-inner">

                                <div className="active carousel-item px-0">
                                    <ul className="row px-0 mx-auto">	
                                        {this.props.latest.map((prd, index) => (
                                            index < 4 && <li key={index} className="col-sm-3" >
                                                <div className="product-box">
                                                    <div onClick={() => this.viewLatestDetail(prd)} >
